    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('administrador', 'Administrador'), ('portero', 'Portero'), ('residente', 'Residente'), ('arrendatario', 'Arrendatario'), ('administrativo', 'Administrativo')], max_length=20)),
